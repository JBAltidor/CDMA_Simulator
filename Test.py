...
# Spreaded = Message_Spreader(message)
# Encoded = Message_Encoder (Spreaded , Key_1)
# Noise  = Noise_Generator (len(Spreaded))
# Traffic = Multiplexing(Message_Encoder(Message_Spreader(message),Key_1),Message_Encoder(Message_Spreader(message_2),Key_2),Noise_Generator(len(Message_Spreader(message_2))))

# print(Decoder(Traffic,Key_2))
...
#Cas 3 : 2 utilisateur et Presence de Bruit
